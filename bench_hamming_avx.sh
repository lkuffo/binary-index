...
#n_vectors=(256 512 1024 2048 4096 8192 16384 32768 65536 131072 262144 524288 1048576 4194304 16777216 134217728)
...
do
    ...
    do
        ...
        do
            uv run --script kernels_hamming_avx.py --count ${n_vector} --ndims ${d} --k 10 --query_count ${query_count} --output $outfile
        done
    done
done
